...
class PluggedHole(BaseModel):
    ...
    hole_type: PluggedHoleType = Field(alias="holeType", description="Type of hole")
...
class PlateHole(BaseModel):
    ...
    planned_hole_type: PlannedHoleType = Field(alias="holetype", max_length=16, description="Hole type string")
    target_type: TargetType = Field(alias="targettype", max_length=9, description="Target type string")
